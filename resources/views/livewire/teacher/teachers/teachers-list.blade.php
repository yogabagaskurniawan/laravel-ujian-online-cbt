                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        <div class="action-btns ms-3">
                                            ...
                                            <a wire:confirm="Apakah anda yakin ingin menghapus?" wire:click="deleteTeacher({{ $teacher->id }})" class="action-btn btn-delete bs-tooltip" data-toggle="tooltip" data-placement="top" aria-label="Delete" data-bs-original-title="Delete">
