                        ...
                        <form class="" wire:submit="updateSettingQuestion">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12 mt-2">
                                    <label for="testAttempts">Izinkan murid bisa mengerjakan lebih dari satu kali?</label>
                                    <select wire:model="testAttempts" id="testAttempts" class="form-select">
                                        <option value="" selected>Pilih opsi</option>
                                        <option value="1">Ya</option>
                                        <option value="0">Tidak</option>
                                    </select>
                                    @error('testAttempts') <span class="error text-danger">{{ $message }}</span> @enderror 
                                </div>
                            </div>
