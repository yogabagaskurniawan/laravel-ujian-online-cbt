    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('studentList', $testResult->getCourse->uid) }}">Kelas Murid</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Murid</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col-lg-12 layout-spacing layout-top-spacing">
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <div class="">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4 class="mb-0">{{ $testResult->getCourse->name }}</h4>
                            <p class="">{{ $testResult->getCourse->getCategory->name }}</p>
                            <p>
                                ...
                                {{ $testResult->getCourse->created_at }}  
                ...
                <h5 class="mt-3">Edit murid {{ $testResult->getUser->getDetailUser->name }}</h5>
                <form class="" wire:submit="addStudent">
                    <div class="row mb-4">
                        <div class="col-sm-12 mt-2">
                            <label for="category">Izinkan murid mengerjakan ulang?</label>
                    ...
                    <div class="row mb-4">
                        <label for="formFile" class="form-label">Input Sertifikat</label>
                        <input class="form-control" type="file" id="formFile">
                        @error('') <span class="error text-danger ">{{ $message }}</span> @enderror 
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Edit Murid</button>
                </form>
            </div>
        </div>
    </div>
